...
```
git clone https://github.com/BlueWe11s/api_yamdb
```
...
По адресу /redoc доступна документация по работе с проектом:
```
...
- [Никита Казанцев](https://github.com/KobaLuck)
- [Сергей Булава](https://github.com/SergeyBulava)